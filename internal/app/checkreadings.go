...
const (
	...
	watchReadingLabelGlusterBricksExpected    = "Gluster bricks expected"
	watchReadingLabelGlusterBricksOnline      = "Gluster bricks online"
	watchReadingLabelGlusterHealEntries       = "Gluster heal backlog"
	watchReadingLabelGlusterIssues            = "Gluster issues"
	watchReadingLabelGlusterPeersConnected    = "Gluster peers connected"
	watchReadingLabelGlusterPeersDisconnected = "Gluster peers disconnected"
	watchReadingLabelGlusterPeersExpected     = "Gluster peers expected"
	watchReadingLabelGlusterSelfHealOnline    = "Gluster self-heal online"
	watchReadingLabelGlusterSelfHealTotal     = "Gluster self-heal total"
	watchReadingLabelGlusterSplitBrainEntries = "Gluster split-brain entries"
